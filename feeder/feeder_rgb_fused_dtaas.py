...
from feeder import segment_rgbbody_dtaas as rgb_roi # [수정]
...
class Feeder(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.rgb_path_dtaas = '/home/irteam/dcloud-global-dir/NIAMoCap/Data/MMNet/final_fivefs/' # [수정]
    ...
    def __getitem__(self, index):
        ...
        # [수정] 여기 아래 보면 if True or 구문이라서 엥간하면 실행되게 되어있었음.. 우린 어짜피 roi 다 만든다음에 실행할거라서 걍 없앰.
        ...
        # else:
        #     rgb = filename + '.png'
        #     rgb = Image.open(self.rgb_path_dtaas + rgb) 
        rgb = filename + '.png'
        rgb = Image.open(self.rgb_path_dtaas + rgb) # [수정] path 이름 수정함
