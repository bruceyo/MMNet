...
r2_gcn = open('./results/ntu60/' + protocol + '/bone_result_stgcn.pkl', 'rb')
r2_gcn = list(pickle.load(r2_gcn).items())

r1_2s = open('./results/ntu60/' + protocol + '/joint_result_2sagcn.pkl', 'rb')
r1_2s = list(pickle.load(r1_2s).items())
r2_2s = open('./results/ntu60/' + protocol + '/bone_result_2sagcn.pkl', 'rb')
r2_2s = list(pickle.load(r2_2s).items())

r1_g3d = open('./results/ntu60/' + protocol + '/joint_result_msg3d.pkl', 'rb')
r1_g3d = list(pickle.load(r1_g3d).items())
r2_g3d = open('./results/ntu60/' + protocol + '/bone_result_msg3d.pkl', 'rb')
r2_g3d = list(pickle.load(r2_g3d).items())


r3_rgb = open('./results/ntu60/' + protocol + '/rgb_fused_result.pkl', 'rb')
...
for i in tqdm(range(len(label[0]))):
    ...
    _, r11_gcn = r1_gcn[label_in_g3d[i][0]]
    _, r22_gcn = r2_gcn[label_in_g3d[i][0]]
