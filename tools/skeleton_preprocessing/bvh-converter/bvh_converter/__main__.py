...
def main():
    ...
    os.system('sudo chmod 777 '+ '/home/irteam/YJ2/' + today + '/')
    file_out = '/home/irteam/YJ2/' + today + '/' + file_in[-30:-4] + "_worldpos.csv"
    #file_out = '/home/irteam/YJ2/update/' + file_in[-30:-4] + "_worldpos.csv"
    ...
    if do_rotations:
        file_out = '/home/irteam/YJ2/' + today + '/' + file_in[-30:-4] + "_rotations.csv"
        #file_out = '/home/irteam/YJ2/update/' + file_in[-30:-4] + "_rotations.csv"
