...
if __name__ == '__main__':
    ...
    parser.add_argument('--part1-path', default='/mnt/nas/ntu-rgbd/NTU/3d_skeletons/nturgb+d_skeletons/')
    parser.add_argument('--part2-path', default='/mnt/nas/ntu-rgbd/NTU120/3d_skeletons/')
    parser.add_argument('--ignored-sample-path',
                        default='./data/nturgbd_raw/NTU_RGBD120_samples_with_missing_skeletons.txt')
    parser.add_argument('--out-folder', default='/media/bruce/2Tssd1/data/ntu120/')
