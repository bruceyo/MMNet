...
class Processor(IO):
    ...
    def start(self):
        ...
        if self.arg.phase == 'train':
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                ...
                if ((epoch + 1) % self.arg.eval_interval == 0) or (
                    ...
                    # save model if achieved the best Bruce 20191010
        ...
        # test phase
            ...
            #self.arg.weights = '/media/bruce/2T/data/st-gcn/with-rgb/full_rgb_crop_skl_pre_t_3_2ndfusion_2/epoch75_model.pt'
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('-j', '--skeleton_joints_pkl', default='./work_dir/tmp', help='the work folder for storing results')
        parser.add_argument('-b', '--skeleton_bones_pkl', default='./work_dir/tmp', help='the work folder for storing results')
        return parser
